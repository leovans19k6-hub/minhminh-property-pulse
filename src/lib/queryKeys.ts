...
export const queryKeys = {
  ...
  // Phase 7C.1 — Mobile Sales Policies
  mobilePolicies: (filters: Record<string, unknown> = {}) =>
    ["mobile", "policies", "search", normalize(filters)] as const,
  ...
  // Phase 7C.3 — Mobile Events
  mobileEvents: (filters: Record<string, unknown> = {}) =>
    ["mobile", "events", "search", normalize(filters)] as const,
  mobileEventDetail: (
    id: string,
    productId?: string | null,
    policyId?: string | null,
