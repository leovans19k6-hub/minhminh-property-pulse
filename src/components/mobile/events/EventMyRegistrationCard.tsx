...
export function EventMyRegistrationCard({ detail }: { detail: MobileEventDetail }) {
      ...
      <ul className="space-y-2">
        {my.registrations.map((r) => (
          ...
          >
            ...
            <span className={`shrink-0 rounded-full px-2 py-0.5 text-[11px] font-semibold ${tone(r.status)}`}>
